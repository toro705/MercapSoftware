...
Class Input_captcha extends Campo{
	...
	function __construct( $datos ){
		...
		$this->site_key 	= $this->site_key==''   ?  '6LeJIQsUAAAAANpmr2Sc3DtT3jHAhT4SSAkIS17B' : $this->site_key;
		$this->secret_key 	= $this->secret_key=='' ?  '6LeJIQsUAAAAAK9I3Qje-8tIhbMlFuevCET-CZJQ' : $this->secret_key;
